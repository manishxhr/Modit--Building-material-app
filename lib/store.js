...
const seed = {
  ...
  suppliers: [
    { id: 1, name: 'MetroBuild Supply', city: 'Gurugram', rating: 4.9, delivery: 24, quality: 'A+', focus: 'Cement, steel & aggregate', categories: ['Cement', 'Steel', 'Sand & Aggregate'], status: 'Verified' },
    { id: 2, name: 'NCR Material Hub', city: 'Noida', rating: 4.8, delivery: 36, quality: 'A', focus: 'Bulk contractor pricing', categories: ['Cement', 'Bricks & Blocks', 'Tiles & Finishes'], status: 'Verified' },
    { id: 3, name: 'Delhi ProBuild', city: 'Delhi', rating: 4.7, delivery: 48, quality: 'A', focus: 'Finishes & interiors', categories: ['Tiles & Finishes', 'Paint & Coatings', 'Plywood & Glass'], status: 'Verified' },
    { id: 4, name: 'Axis Construction Exchange', city: 'Faridabad', rating: 4.6, delivery: 30, quality: 'A', focus: 'Multi-site procurement', categories: ['Steel', 'Sand & Aggregate', 'Hardware'], status: 'Verified' },
    { id: 5, name: 'Ghaziabad Build Depot', city: 'Ghaziabad', rating: 4.5, delivery: 40, quality: 'A', focus: 'Warehouse & infra supply', categories: ['Cement', 'Bricks & Blocks', 'Electrical'], status: 'Verified' },
    { id: 6, name: 'Greater Noida Supply Co.', city: 'Greater Noida', rating: 4.4, delivery: 44, quality: 'B+', focus: 'Planned township projects', categories: ['Plumbing', 'Electrical', 'Hardware'], status: 'Verified' }
  ],
  demandForecast: [
    { category: 'Cement', change: 18 },
    { category: 'Steel', change: 11 },
    { category: 'Tiles & Finishes', change: -4 },
    { category: 'Sand & Aggregate', change: 7 },
    { category: 'Electrical', change: 9 }
  ],
  rfqs: [], orders: [], activity: [], cart: []
};
